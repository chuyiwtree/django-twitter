# Generated by Django 3.1.3 on 2021-06-13 23:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tweets', '0002_auto_20210505_0235'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'index_together': {('user', 'created_at'), ('tweet', 'order'), ('has_deleted', 'created_at'), ('status', 'created_at')},
            },
        ),
    ]
